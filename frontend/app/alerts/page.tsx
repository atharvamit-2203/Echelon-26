...
import { AlertTriangle, CheckCircle, Clock, Trash2, Eye, Filter, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-6 flex gap-3 flex-wrap">
          ...
          <button className="ml-auto px-4 py-2 bg-slate-800 text-slate-300 hover:text-white rounded-lg font-medium transition">
